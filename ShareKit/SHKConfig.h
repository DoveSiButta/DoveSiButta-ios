...
#define SHKMyAppName			@"DoveSiButta"
#define SHKMyAppURL				@"http://dovesibutta.cloudapp.net"
 ...
 */
#define SHKTwitterConsumerKey		@"rGLUXSFiMyMPr7Okr4u1OQ"
#define SHKTwitterSecret			@"MhazEJuVdsDjTRosafhIYKbBjHbJgZAcIEmvYJzI0"
#define SHKTwitterCallbackUrl		@"http://dovesibutta.cloudapp.net" // You need to set this if using OAuth, see note above (xAuth users can skip it)
#define SHKTwitterUseXAuth			0 // To use xAuth, set to 1
#define SHKTwitterUsername			@"dovesibutta" // Enter your app's twitter account if you'd like to ask the user to follow it when logging in. (Only for xAuth)

// Bit.ly (for shortening URLs on Twitter) - http://bit.ly/account/register - after signup: http://bit.ly/a/your_api_key
#define SHKBitLyLogin				@"maggix"
#define SHKBitLyKey					@"R_9638bcdc0bb2d0ce94bef2eb065235e8"
